...
<body>
	...
	<main>
		...
		<section id="sectionactu">
			<h1 class="h1actu underlineactu">Marché</h1>
			<article class="savoiractu">
		...
		<section id="sectionactu">
			<h1 class="h1actu underlineactu">Festival</h1>
			<article class="savoiractu">
				 <p>Encore un dernier effort et la voilà enfin libérée de son carcan. Abandonnant son exuvie éventrée comme une dernière relique de sa vie passée, la voilà enfin libre. En s’envolant, elle passe si près de ma joue que je suis obligé de l’écarter d’un geste de la main. je m’appelle Jeanne. Les évènements que je vais vous raconter se sont déroulés il y a longtemps, sur plussieurs générations.</p>
				 <a href="https://www.africafete.com/africa-fete-a-marseille/"><img src="images/africafete.jpg"></a>
				 <p>Quand je pense à toutes ces années et malgré certains côtés tragiques, je suis nostalgique. J’ai souvent l’esprit ailleurs, les yeux dans le vague et quand quelqu’un me tape sur l’épaule en me demandant à quoi je pense, je lui réponds tout simplement à rien…</p>
			</article>
			<hr class="actu">
		</section>
		...
		<section id="sectionactu">
			<h1 class="underlineactu h1actu">Ateliers</h1>
			<article class="savoiractu">
...
.underlineactu {
    ...
    background: url(images/marron.jfif);
}
